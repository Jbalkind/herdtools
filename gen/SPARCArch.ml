...
include SPARCBase
let tr_endian x = MachSize.tr_endian MachSize.Quad x
...
let strong = StoreLoad

let pp_fence = pp_barrier

let fold_all_fences f r = f StoreLoad r
let fold_cumul_fences f r = f StoreLoad r
let fold_some_fences f r = f StoreLoad r
